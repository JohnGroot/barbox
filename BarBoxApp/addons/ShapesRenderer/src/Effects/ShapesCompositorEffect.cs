...
using static ShapesRenderer.Utils.MemoryHelpers;
using System.Runtime.InteropServices;
using ShapesRenderer.Utils;

namespace ShapesRenderer.Effects;

[Tool]
[GlobalClass]
public partial class ShapesCompositorEffect: CompositorEffect {
	...
	public ShapesCompositorEffect():base() {
	...
	static readonly string[] SHADER_PATHS = new [] {
		"res://addons/shapes_renderer/shaders/polyline.glsl",
		"res://addons/shapes_renderer/shaders/polyline.glsl"
	};
	...
	public static void _Init(ShapesCompositorEffect instance) {
		ShapeResources InitPolylineResources() {
			...
			var shaderFile = GD.Load<RDShaderFile>("res://addons/shapes_renderer/shaders/polyline.glsl");
