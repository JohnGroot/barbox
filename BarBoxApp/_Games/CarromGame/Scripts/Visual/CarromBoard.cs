...
public partial class CarromBoard : Node2D
{
	...
	[Export]
	public Color PocketColor { get; set; } = Colors.Black;

	[Export]
	public bool UseCurvedBorders { get; set; } = false;
	...
	private float _f_BASELINE_MARGIN_PERCENT = 0.068f; // F=10.15cm out of 74cm, closer to edge
	...
	private float _i_BASELINE_LENGTH_PERCENT = 0.361f; // I=26.70cm out of 74cm
