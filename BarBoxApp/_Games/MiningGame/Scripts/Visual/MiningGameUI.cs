...
public partial class MiningGameUI : Control
{
	...
	/// <summary>
	/// Display an error message to the user via the shared platform notification overlay.
	/// </summary>
	public void ShowError(string errorTitle, string errorMessage)
	{
		_game?.ShowNotification($"{errorTitle}: {errorMessage}", NotificationSeverity.Error);
	}
