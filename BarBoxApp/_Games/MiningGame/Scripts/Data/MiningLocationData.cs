...
public partial class MiningLocationData : Resource
{
	...
	public string GetUpgradeEmoji(UpgradeType upgradeType) => upgradeType switch
	{
	...
	public string GetUpgradeDisplayName(UpgradeType upgradeType) => upgradeType switch
	{
	...
	public string GetUpgradeDescription(UpgradeType upgradeType) => upgradeType switch
	{
	...
	public string GetGemEmoji(GemType gemType) => gemType switch
	{
		GemType.Ruby => "🟥",
		GemType.Sapphire => "🔷",
		GemType.Emerald => "🟢",
	...
	public Color GetGemColor(GemType gemType) => gemType switch
	{
