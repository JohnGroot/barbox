...
3. **Godot 4.4.1**: `godotenv godot install 4.4.1`
...
1. Open Godot 4.4.1: `godotenv godot`
...
godotenv godot use 4.4.1   # Switch active version
...
godotenv godot use 4.4.1     # Switch to correct version
```
...
```
barbox/
├── BarBoxApp/           # Godot 4.4.1 C# game client
